...
const EditStack = ({ location }) => {
  const [values, setValues] = useState({
    id: location.state.itemId,
    name: location.state.techStack,
    percentage: location.state.skill,
    lastWeek: location.state.week,
    lastMonth: location.state.month,
    error: "",
    redirectTo: false,
    loading: false,
  });
  ...
  const form = () => (
    <div className="mb-5 d-flex justify-content-center">
      <div className="card mt-5 md-2" style={{ width: "30rem" }}>
        ...
        <h5 className="card-header text-center text">Edit TechStack</h5>
