...
const EditProject = ({ location }) => {
  const [values, setValues] = useState({
    ...
    link: location.state.projectLink,
    language: location.state.projectLanguage,
    error: "",
    redirectTo: false,
    loading: false,
  });

  const { id, name, link, language, redirectTo, loading } = values;
  ...
  const form = () => (
    <div className="mb-5 d-flex justify-content-center">
      <div className="card mt-5 md-2" style={{ width: "30rem" }}>
        ...
        <h5 className="card-header text-center text">Edit Project</h5>
